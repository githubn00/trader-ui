...
function BidZeroChkWidget(cbIdx, paramKey) {
  return function(t) {
    let chk, chkHandler;
    return {
      c() {},
...
function MACD_FmOs(t, e, s) {
  ...
  return l2(), t.${ds}set = t2 => { ${q1}settings${q1} in t2 && l2(s(0, i=t2.settings)); }, [
    ...
    v => { t.${ds}.not_equal(n.params.showBidZeroLabel, v) && (n.params.showBidZeroLabel = v, i.set(n)); },
  ];
}
function MACD_FmRs(t) {
  let e1, e2, e3, e4, nn;
  const BizChk    = BidZeroChkWidget(2, ${q1}showBidZero${q1});
  const BizSt     = XoverStPicker(3, 4, 5, true, ${q1}bidZero${q1});
  const BizLblChk = BidZeroChkWidget(6, ${q1}showBidZeroLabel${q1});
  ...
  e4 = new R({ props: { label: ${q1}Bid Zero Label${q1}, ${ds}slots: { default: [BizLblChk] }, ${ds}scope: { ctx: t } } });
  return {
    c() { _(e1.${ds}.fragment); _(e2.${ds}.fragment); _(e3.${ds}.fragment); _(e4.${ds}.fragment); },
    m(t2, ins) { k(e1, t2, ins); k(e2, t2, ins); k(e3, t2, ins); k(e4, t2, ins); nn = !0; },
    p(t2, [drt]) {
      if (1 & drt) e1.${ds}set({ settings: t2[0] });
      if (2 & drt) { const sc = { ${ds}scope: { dirty: drt, ctx: t2 } }; e2.${ds}set(sc); e3.${ds}set(sc); e4.${ds}set(sc); }
    },
    i(t2) { nn || (l(e1.${ds}.fragment, t2), l(e2.${ds}.fragment, t2), l(e3.${ds}.fragment, t2), l(e4.${ds}.fragment, t2), nn = !0); },
    o(t2) { o(e1.${ds}.fragment, t2); o(e2.${ds}.fragment, t2); o(e3.${ds}.fragment, t2); o(e4.${ds}.fragment, t2); nn = !1; },
    d(t2) { b(e1, t2); b(e2, t2); b(e3, t2); b(e4, t2); }
  };
}
